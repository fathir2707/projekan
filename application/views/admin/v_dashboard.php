...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li>
         ...
         <li>
          <a href="<?php echo base_url().'dash_login'?>">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020 <a href="https://www.linkedin.com/in/fathi-rabbani-aa7953155/">Fathi Rabbani</a>.</strong> All rights reserved.
  </footer>
