              ...
              <div class="col-xs-6 col-sm-8 col-md-9">
                  <div class="header-top_address">
                        <div class="header-top_list">
                            <span class="icon-phone"></span>161
                        </div>
                        <div class="header-top_list">
                            <span class="icon-envelope-open"></span>posindonesia.co.id
                        </div>
                        <div class="header-top_list">
                            <span class="icon-location-pin"></span>Cirebon, Jawa Barat, INA. 45100
                        </div>
                  </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6">
                            <div class="contact-address">
                                ...
                                <div class="contact-details">
                                    ...
                                    <h6>Alamat</h6>
                                    <p> Kantor Pos Pemeriksa (Kprk)
                                        <br> Cirebon
                                        <br> Jawa Barat, INA. 45100</p>
                                    </div>
                                    <br>
                                    <div class="contact-details">
                                        <i class="fa fa-envelope-o" aria-hidden="true"></i>
                                        <h6>Email</h6>
                                        <p>halopos@posindonesia.co.id
                                        </p>
                                    </div>
                                    <br>
                                    <div class="contact-details">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="foot-logo">
                        ...
                        <p><?php echo date('Y');?> © copyright by <a href="https://www.linkedin.com/in/fathi-rabbani-aa7953155/" target="_blank">Fathi Rabbani</a>. <br>All rights reserved.</p>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="sitemap">
                    ...
                    <div class="col-md-3">
                        <div class="address">
                            <h3>Hubungi Kami</h3>
                            <p><span>Alamat: </span> Cirebon, Jawa Barat, INA. 45100</p>
                            <p>Email : halopos@posindonesia.co.id
                                <br> Halopos : 161</p>
